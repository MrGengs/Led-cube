...
document.addEventListener('DOMContentLoaded', () => {
    const cards = document.querySelectorAll('.feature-card, .activity-card, .product-card');
...
window.addEventListener('scroll', () => {
    ...
    cubes.forEach((cube, index) => {
        ...
        cube.style.transform = `translateY(${scrolled * speed}px) rotate(${scrolled * 0.5}deg)`;
    });
});
